...
<div class="row">
 ...
 <div class="card-deck colo-md-4" style="width:250px;" >
  ...
  <div class="card-body"><center>
    ...
    <a href="category2.php?cat=clothing" class="btn btn-primary">See More</a></center><br>
  </div>
</div>
</div>
  <div class="col-lg-3">
<div class="card-deck colo-md-4" style="width:250px">
  ...
  <div class="card-body"><center>
    ...
    <a href="category2.php?cat=access" class="btn btn-primary">See More</a></center><br>
  </div>
</div>
</div>
  <div class="col-lg-3">
<div class="card-deck colo-md-4" style="width:250px">
  ...
  <div class="card-body">
    ...
    <a href="category2.php?cat=shoes" class="btn btn-primary">See More</a></center><br>
  </div>
</div>
</div>
 <div class="col-lg-3" >
 <div class="card-deck colo-md-4" style="width:250px" >
  ...
  <div class="card-body"><center>
    ...
    <a href="category2.php?cat=miscellaneous" class="btn btn-primary">See More</a></center><br>
  </div>
</div>
</div>
</div>
...
<a class="an" href="category2.php?cat=$catname"> <?php echo $row2['subcat'] ?> </a><br>
</div>
<?php
}
?>
...
?>
 ...
 <div class="card colo-md-4" style="width:250px;" >
  ...
  <div class="card-body"><center>
    ...
    <a href="product2.php?id= <?php echo $id ?>" class="btn btn-primary">See Details</a></center><br>
  </div>
</div>
<br>
<br>
