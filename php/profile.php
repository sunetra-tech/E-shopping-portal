  ...
  <div class="container-fluid">
   ...
   <div class="edit-main-container">
    ...
    <div class="edit-profile-detail-container">
        <label>Name: <?php echo $res['name'] ?></label><br><br>
        

        <label>Email: <?php echo $res['email'] ?></label><br><br>


        <label>Phone: <?php echo $res['phone'] ?></label><br><br>

        <!--<label>Address: <?php if($row2['address']!='') echo $row2['address'] ?></label>--><br><br>
